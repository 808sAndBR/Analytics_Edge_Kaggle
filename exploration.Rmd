...
prop.table(table(training$EducationLevel, useNA = "always"))[is.na(names(prop.table(table(training$EducationLevel, useNA = "always"))))] >.05
...
class(ans_missing$per)

qplot(ans_missing$qustion, y= ans_missing$perc_missing )
?qplot
